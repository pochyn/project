...
@Component({
  selector: 'app-kv-comments',
  templateUrl: './kv-comments.component.html',
  styleUrls: ['./kv-comments.component.css']
})
export class KvCommentsComponent implements OnInit {
      ...
      .map(actions => {
        return actions.map(a => {
          ...
          return { id, data };
                                    ...
                                    && post.data.comments != '' && !post.data.archieved_kv));
