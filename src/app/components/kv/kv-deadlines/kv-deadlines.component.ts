...
@Component({
  selector: 'app-kv-deadlines',
  templateUrl: './kv-deadlines.component.html',
  styleUrls: ['./kv-deadlines.component.css']
})
export class KvDeadlinesComponent implements OnInit {
        ...
        .map(actions => {
          return actions.map(a => {
            ...
            return { id, data };
                                      ...
                                      && post.data.deadline != ''  && post.data.deadline > dt && !post.data.archieved_kv));
