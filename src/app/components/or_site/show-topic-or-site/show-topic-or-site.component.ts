...
@Component({
  selector: 'app-show-topic-or-site',
  templateUrl: './show-topic-or-site.component.html',
  styleUrls: ['./show-topic-or-site.component.css']
})
export class ShowTopicOrSiteComponent implements OnInit {
