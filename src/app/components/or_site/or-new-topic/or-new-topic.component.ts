...
@Component({
  selector: 'app-or-new-topic',
  templateUrl: './or-new-topic.component.html',
  styleUrls: ['./or-new-topic.component.css']
})
export class OrNewTopicComponent implements OnInit {
