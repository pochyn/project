...
@Component({
  selector: 'app-archieve-or-site',
  templateUrl: './archieve-or-site.component.html',
  styleUrls: ['./archieve-or-site.component.css']
})
export class ArchieveOrSiteComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.posts = this.postsColGaz.snapshotChanges()
      ...
      }).map(posts => posts.filter(post => post.data.site_type
