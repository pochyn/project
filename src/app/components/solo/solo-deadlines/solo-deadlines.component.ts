...
@Component({
  selector: 'app-solo-deadlines',
  templateUrl: './solo-deadlines.component.html',
  styleUrls: ['./solo-deadlines.component.css']
})
export class SoloDeadlinesComponent implements OnInit {
    ...
    .map(actions => {
      return actions.map(a => {
        ...
        return { id, data };
                                  ...
                                  && post.data.deadline != '' && post.data.deadline > dt && !post.data.archieved_solo));
