...
@Component({
  selector: 'app-solo-posts',
  templateUrl: './solo-posts.component.html',
  styleUrls: ['./solo-posts.component.css']
})
export class SoloPostsComponent implements OnInit {
