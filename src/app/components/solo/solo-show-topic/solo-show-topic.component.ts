...
@Component({
  selector: 'app-solo-show-topic',
  templateUrl: './solo-show-topic.component.html',
  styleUrls: ['./solo-show-topic.component.css']
})
export class SoloShowTopicComponent implements OnInit {
  ...
  archieve(postid){
    this.afs.doc('posts/'+postid).update({archieved_solo: true});
    this.getData();
  }
