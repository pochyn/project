...
export const appRoutes: Routes = [
    ...
    {path: 'dashboard_or_gazeta', component: DashboardOrGazetaComponent, canActivate: [AuthguardService]},
    {path: 'dashboard_or_site', component: DashboardOrSiteComponent, canActivate: [AuthguardService]},
